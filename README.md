...
### Primary Target User
RSU student **sellers** moving out under time pressure (especially graduating and international students) who must sell higher-value used items such as furniture, appliances, monitors and clothing within days. Student **buyers** at move-in are served by the same MVP screens.
