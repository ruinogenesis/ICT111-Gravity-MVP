...
| /wireframes/record-list.png | Browse all listings | Search bar, category chips (All / Furniture / Appliances / Electronics / Clothing / Sneakers / Other), listing cards with photo placeholder, title, price, and status badge; realistic demo data from /data/sample-listings.csv | FR-05, FR-06, FR-08 |
