...
| --- | --- | --- | --- | --- | --- |
| Existing LINE apartment & class groups | Sellers moving out | "Stop posting into the void — one searchable place" | Click demo link | AM-02 CTA clicks, AM-03 demo attempts | E01 evidence: this is exactly where buy/sell chaos happens today, so the audience is pre-qualified — we intercept the problem where it lives |
| QR posters in apartment lobbies & elevators (A, B, Building 6) | Sellers packing rooms; buyers moving in | "Moving out? Don't bin it — scan and list it" | Scan QR → landing page | AM-01 views (per poster code), AM-05 interest | CS01's channel from customer-segments.csv; physically next to the items being sold, at the exact moment of the pain |
| Instagram story (team + friends resharing) | Broad RSU student community | Before/after: "thrown-away desk vs 800 THB in 3 days" | Visit landing page | AM-01 views, AM-02 clicks | Familiar student channel; visual format suits item photos; reshares reach incoming students not yet in apartment friends group chats |
...
3. Post to 3 LINE apartment and class group chats with the chat message from marketing-message.md.
...
5. **Off-season timing** (semester calendar vs. course deadline). Mitigation: for the course, measure with classmates and students living in apartments and condos now; document the peak-season plan for a real launch in the final report.
