...
AM-04 feedback responses: 12. AM-06 best-performing channel: **dorm/friend groups** (77.3% CTA, 54.5% demo rate combined) versus social stories (5.2% CTA, 1.6% demo rate).

## Interpretation
The result is a clean, honest split: reach and intent moved in opposite directions. Social stories produced 93% of the views (308 of 330) but only 5 demo attempts and 2 testers, while the two dorm/friend groups produced 22 views and 12 demo attempts — a demo rate roughly 34× higher. This validates the Lab 12 channel choice: Gravity's audience is reached where the problem already lives (dorm and class groups, exactly the E01 evidence), not through broad social broadcast. Targets were met on the awareness side (330 views vs ≥30) and the feedback side (12 vs ≥5), and exceeded on demo attempts (17 vs ≥10); overall CTA rate (10.0%) and interest conversion (3.6%) fell short of the ≥30% and ≥20% targets — but those targets were written assuming a targeted audience, and they are comfortably exceeded within the dorm-group segment (77.3% CTA, 54.5% demo). The lesson we would carry into a real launch: drop broad social entirely, concentrate on dorm groups and QR posters at move-out peak, and measure per-channel rather than in aggregate.
