...
|---|---|---|---|---|---|
| Users are informed about the purpose of the prototype. | Yes | Homepage states purpose, target user, and main actions (FR-01); demo page carries a visible note that records are saved in the browser only and the demo is for the Lab experiment. | Keep the purpose note on every prototype version; add a short data-use line to the register screen (S-02) in Sprint 1. | Hein (Product/Docs) | Issue #44 |
