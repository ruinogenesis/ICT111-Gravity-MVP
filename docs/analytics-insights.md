...
|---|---|---|
| Total test users | Count testers | |
| Completed tasks | Count Task_Completed = Yes | |
| Task success rate | Completed tasks / total testers | |
| Average feedback score | Average of 1-5 scores | |
| Average interest level | Average of 1-5 scores | |
| Confusion points | Count repeated confusion categories | |
